<template>
    <div class="feedback-section" id="feedback-section">
        <div class="feedback-title">
            <h2>{{ t.titles.home.feedback }}</h2>
        </div>

        <div class="stars">
            <svg v-for="n in 5" :key="n" @click="selectedMark = n" @mouseover="hoverMark = n"
                @mouseleave="hoverMark = null" :class="{ active: n <= (hoverMark ?? selectedMark) }"
        ...
        <div class="feedback-text">
            ...
            <input type="text" placeholder="Your feedback" class="feedback-input" v-model="feedbackText" />
