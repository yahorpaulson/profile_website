  ...
  <div class="admin" v-if="isLoggedIn">
    ...
    <div v-if="currentAction === 'edit' && projectFound" class="edit-context-menu">
      ...
      <textarea v-if="['goals', 'insights'].includes(editableProject.field)"
        v-model="editableProject[editableProject.field][editableProject.language]" :id="editableProject.field"
        rows="4"></textarea>
      ...
      <div v-if="editableProject.field && editableProject.language" class="field-row">
        ...
        <input v-if="editableProject.field === 'inProgress'" v-model="editableProject.inProgress" type="checkbox"
          :id="editableProject.field" />
        <input v-else v-model="editableProject[editableProject.field][editableProject.language]" type="text"
          :id="editableProject.field" />
      </div>
